...
namespace Zadaca2
{
    ...
    public class ZamjenskiObjekat : StubInterface
    {
        public string[] ime()
        {
            string[] ime = { "Berin", "Neko", "Mahmut", "Adis", "Mahir" };
            return ime;
        }
        public string[] prezime()
        {
            string[] prezime = { "Masovic", "Nekic", "Mahmutovic", "Kos", "Korac" };
            return prezime;
        }
        public string[] datum_rodenja()
        {
            string[] datum_rodenja = { "2001-05-12", "2012-02-02", "1998-11-01", "2001-05-10", "1978-12-28" };
            return datum_rodenja;
        }
        public int[] visina()
        {
            int[] visina = { 192, 152, 182, 188, 179 };
            return visina;
        }
        public int[] tezina()
        {
            int[] tezina = { 80, 60, 89, 91, 71 };
            return tezina;
        }
    }
